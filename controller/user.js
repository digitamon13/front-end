...
module.exports.signup = async (req, res, next) => {
   try {
      ...
      let verifyUrl = `www.fagoremit.com/verification/${accessToken}`
            ...
            "Messages": [
               {
                  ...
                  "Subject": "Account Verification",
                  "TextPart": `Dear ${email}, welcome to fagoremit! please click the link  ${verifyUrl}  to verify your email!`,
               ...
               "Messages": [
                  {
                     ...
                     "Subject": "Account Verification",
                     "TextPart": `fagoremit verificatioon code is ${accessToken}
                             `,
                     "HTMLPart": `<div>
                             <p>
                             fagoremit verificatioon code is ${accessToken}
                             </p>
            ...
            "Messages": [
               {
                  ...
                  "Subject": "Account Verification",
                  "TextPart": `Dear ${savedUser.email}, welcome to fagoremit,Smart-free banking for everybody.
